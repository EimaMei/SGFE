# RGFW Embedded
RGFW Embedded is an oficially endorsed port of the RGFW library for embedded 
...
|----------------------|:--------------------------------------|:-------------:|:-------------------------------------:|
| Nintendo 3DS         | [EimaMei](https://github.com/EimaMei) | RGFW 1.7.5    | Homebrew port utilizing `libctru`.
